  ...
  const getFirst = async () => {
    ...
    try {
      let data = await getForwardedGacha({
        authToken:
          "fW60Zw10LJ3LvRNV0HERP%2Bg9S6V8hMM1tzsu6ll5mnSnIccX0C17ccRnjMg5AphcGqXu1rlGFsN4yZFD7K0M1V3HQC6YCHc7b4ck87wkn7GZBMaY7TFXDRMi4lVpMB13OB6rUxB9DBtMUljR1JnJgjbEnUYUYWuefFOVNBbIeLcwcPSDtLCoa2I4hMXbWiLpYIRZT4L8I5OygDrRDbXp0E1Az%2F9Drzz8LqXRWqjdpjtjEJHQtOAmnsmGrAT2Jd%2BGzixRrsJu8e62M%2FFDofT1qM6%2BhjgUfLARfYOlJMxaAZbFr4Ennf9fnrvskz6MUM30F%2FwwigWwOCtGVPSqqrpEEg%3D%3D",
        gachaCode: 301,
        end_id: 0,
      });
      setGachaList(data);
